# 12AB + 12BC + 12CD + 12DE block training.
...
my_sampler = Sample_without_replacement(['a','b', 'c', 'd'])

# Parameters.

# v.session_duration = 1 * hour  # Session duration.
v.trial_num = 49  # Total trial number.
...
def init_trial(event):
    ...
    if event == "entry":
        ...
        elif v.n_trials > 12 and v.n_trials <=24:
            timed_goto_state("choice_state_b", v.ini_duration[0])
        elif v.n_trials > 24 and v.n_trials <=36:
